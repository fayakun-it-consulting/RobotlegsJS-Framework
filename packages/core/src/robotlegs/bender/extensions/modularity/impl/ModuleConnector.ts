...
namespace robotlegs.bender.extensions.modularity.impl {
    ...
    import { IModuleConnectionAction } from "../dsl/IModuleConnectionAction";
    import { IContext, IInjector } from "@robotlegsjs/core";
    /**
     * @private
     */
    export class ModuleConnector implements IModuleConnector {
        ...
        private getOrCreateConfigurator(channelId: string): ModuleConnectionConfigurator {
            return this._configuratorsByChannel[channelId] || this._configuratorsByChannel[channelId] = this.createConfigurator(channelId);
        }
