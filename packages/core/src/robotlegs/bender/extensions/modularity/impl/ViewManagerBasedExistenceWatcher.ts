...
namespace robotlegs.bender.extensions.modularity.impl {
    ...
    import { ViewManagerEvent } from "../../viewManager/impl/ViewManagerEvent";
    import { IContext, ILogger } from "@robotlegsjs/core";
    /**
     * @private
     */
    export class ViewManagerBasedExistenceWatcher {
        ...
        private init(): void {
            for each (var container: HTMLElement in this._viewManager.containers) {
                this._logger.debug("Adding context existence event listener to container {0}", [container]);
                container.addEventListener(ModularContextEvent.CONTEXT_ADD, this.onContextAdd);
            }
        ...
        private destroy(): void {
            for each (var container: HTMLElement in this._viewManager.containers) {
                ...
                container.removeEventListener(ModularContextEvent.CONTEXT_ADD, this.onContextAdd);
            }
        ...
        private onContainerAdd(event: ViewManagerEvent): void {
            ...
            event.container.addEventListener(ModularContextEvent.CONTEXT_ADD, this.onContextAdd);
        }
        ...
        private onContainerRemove(event: ViewManagerEvent): void {
            ...
            event.container.removeEventListener(ModularContextEvent.CONTEXT_ADD, this.onContextAdd);
        }
